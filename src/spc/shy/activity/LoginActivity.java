...
import spc.shy.R;
import spc.shy.adapter.SimpleListDialogAdapter;
import spc.shy.bean.Users;
import spc.shy.dialog.SimpleListDialog;
import spc.shy.dialog.SimpleListDialog.onSimpleListItemClickListener;
import spc.shy.leancloud.LeanChatManager;
...
import spc.shy.view.HandyTextView;
...
//                    if(CommonUtil.isNetworkConnected(mContext)){
                    LeanChatManager.getInstance().loginChatSystem(mNickname);
//                    }

package spc.shy.activity.message;

import java.io.File;
import java.io.IOException;
import java.util.ArrayList;

import spc.shy.ActivitiesManager;
import spc.shy.BaseApplication;
import spc.shy.R;
import spc.shy.activity.ImageBrowserActivity;
import spc.shy.activity.OtherProfileActivity;
import spc.shy.adapter.ChatAdapter;
import spc.shy.bean.Message;
import spc.shy.bean.Message.CONTENT_TYPE;
import spc.shy.bean.Users;
import spc.shy.socket.tcp.TcpClient;
import spc.shy.socket.udp.IPMSGConst;
import spc.shy.sql.SqlDBOperate;
import spc.shy.util.AudioRecorderUtils;
import spc.shy.util.FileUtils;
import spc.shy.util.ImageUtils;
import spc.shy.util.LogUtils;
import spc.shy.util.SessionUtils;
import spc.shy.view.EmoteInputView;
import spc.shy.view.EmoticonsEditText;
import spc.shy.view.MultiListView;
import spc.shy.view.ScrollLayout;
...
public class ChatActivity extends BaseMessageActivity implements OnItemClickListener {
    ...
    private void startRecord() {
        ...
        RECORD_FILENAME = System.currentTimeMillis()
                + spc.shy.util.TextUtils.getRandomNumStr(3);

package spc.shy.activity;

import java.util.ArrayList;
import java.util.List;

import spc.shy.BaseActivity;
import spc.shy.BaseDialog;
import spc.shy.R;
import spc.shy.activity.wifiap.WifiApConst;
import spc.shy.activity.wifiap.WifiapBroadcast;
import spc.shy.activity.wifiap.WifiapBroadcast.NetWorkChangeListener;
import spc.shy.adapter.WifiapAdapter;
import spc.shy.bean.Users;
import spc.shy.dialog.ConnWifiDialog;
import spc.shy.sql.SqlDBOperate;
import spc.shy.sql.UserInfo;
import spc.shy.util.DateUtils;
import spc.shy.util.LogUtils;
import spc.shy.util.SessionUtils;
import spc.shy.util.SharePreferenceUtils;
import spc.shy.util.TextUtils;
import spc.shy.util.WifiUtils;
import spc.shy.util.WifiUtils.WifiCipherType;
